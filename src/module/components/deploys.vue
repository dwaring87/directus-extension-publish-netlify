<template>
  <div class="container">
    <h2>Deploys</h2>
    <v-table v-bind:headers="headers" v-bind:items="deploys" v-bind:sort="{by: 'created_at', desc: true }">
